...
const Profile = () => {
  ...
  let setImg = () => {
    ...
    axios.post("http://localhost:5000/uploadProfileImage", fd, {
  ...
  return (
    <div className="container-fluid profile-container">
      <div className="row justify-content-center">
        <div className="col-md-10 col-lg-8 profile-box shadow-lg">
          <div className="row align-items-center">
            ...
            <div className="col-md-4 text-center profile-sidebar">
              ...
              <input type="file" accept="image/*" onChange={profileImage} className="form-control-file mt-2" />
